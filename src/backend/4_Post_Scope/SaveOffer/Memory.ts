...
- The USER'S LAST MESSAGE block may include an "EXISTING MEMORIES YOU'VE LEARNED ABOUT" section listing previously saved memories. Match the current message against those entries by the moment they describe (the same event / day / scene). If matched, treat the new snippet as an UPDATE and reuse the existing title verbatim so the doc upserts in place.`,
  doNotOffer: `
